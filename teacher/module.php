...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark"> <i class="nav-icon fas fa-file"></i> Module</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="card card-primary card-outline">
          <div class="card-header">
            <h3 class="card-title">Select Student Condition</h3>
          </div>
          ...
          <div class="card-body">
            <div class="row">
              <?php 
                ...
                $module = $disabilityRow['id'];
                $count = $connection->query("SELECT * FROM module WHERE disability = '$module'");
              ?>
                <div class="col-md-3 col-sm-6 col-12">
                  <div class="info-box">
                    <a data-id="<?php echo $disabilityRow['id']; ?>" class="info-box-icon bg-success view-module"><i class="fas fa-user-nurse"></i></a>
