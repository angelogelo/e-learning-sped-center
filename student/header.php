<?php
  ...
  if (isset($_SESSION['student'])) {
    ...
    $disability = $studentRow['disability'];
        ...
        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
          <?php
            if ($studentRow['picture'] == "none" || $studentRow['picture'] == NULL) {
              ...
              ?>
                <img src="../images/student/<?php echo $studentRow['picture']; ?>" class="user-image img-circle elevation-2" alt="User Image">
              <?php
            }
          ?>
          <span class="d-none d-md-inline"><?= $studentRow['fullname']; ?></span>
        </a>
